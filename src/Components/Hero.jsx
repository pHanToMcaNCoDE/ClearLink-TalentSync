...
const Hero = () => {
  ...
  return (
    <div className='pb-[6.25rem] h-[100vh] hero md:relative lg:relative'>
            <img className='hidden w-full h-[50%] lg:h-full object-cover lg:flex justify-center items-center' src={bg} alt='Background'></img>
            <div className='md:absolute md:top-0 md:left-0 md:right-0 md:bottom-0 lg:absolute lg:top-0 lg:left-0 lg:right-0 lg:bottom-0 max-w-[1200px] mx-auto p-2'>
