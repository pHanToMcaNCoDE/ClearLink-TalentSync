...
const Hero = () => {
  ...
  return (
    <div className='pb-[6.25rem] h-[100vh] hero'>
        <img className='lg:relative hidden w-full h-[50%] lg:h-full object-cover lg:flex justify-center items-center' src={bg} alt='Background'></img>
