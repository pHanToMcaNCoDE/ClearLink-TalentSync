  ...
  return (
    <> 
        ...
        <div className='w-full lg:w-[58%]'>
            ...
            {/* Trial button and co */}
            <div className='flex flex-col lg:flex-row justify-center lg:justify-start items-center py-5 gap-x-6'>
            ...
            <div className='flex flex-row justify-center lg:justify-start items-center gap-x-4 pt-1'>
